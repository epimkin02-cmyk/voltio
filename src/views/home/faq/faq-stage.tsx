 ...
 */
/**
 * **Retuned for a vehicle.** The three numbers above were measured against a
 * garment roughly as wide as it was tall, standing off the bottom-left corner
 * behind the questions. A car at 765 units of height is wider than the frame and
 * stops being the screen's ground — it becomes the screen. 300 matches the
 * hero's own resting height, so the two screens hold the vehicle at the same
 * size, and the offsets pull it further left and down so the questions get the
 * whole right half of the frame back.
 */
const STILL = {
  height: 300,
  fillX: 0.52,
